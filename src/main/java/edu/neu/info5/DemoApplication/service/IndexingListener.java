...
//                System.out.println("After SAVE");
    ...
    private void postDocument(JSONObject plan) throws IOException {
        ...
        for (Map.Entry<String, Map<String, Object>> entry : MapOfDocuments.entrySet()) {
            ...
            request.id(objectId);
//            System.out.println("RequestId: " + request.id(objectId));
            request.source(entry.getValue());
//            System.out.println("RequestSource: " + request.source(entry.getValue()));
            request.routing(parentId);
//            System.out.println("RequestRouting: " + request.routing(parentId));
